...
if (url.searchParams.get('by') != null) {
  sender = url.searchParams.get('by=ganti');
} else {
  sender = "Nurizyanie";
}
...
document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Hai Awak", "Saya ada soalan nak tanya", "question").then(function () {
    Swal.fire("Jawab jujur tau!").then(function () {
      Swal.fire("Kalau awak tipu takpe lah", "", "error").then(function () {
        ...
        const {
          ...
          const pertanyaan = Swal.fire({
            title: `${nama} sayang tak ${sender}?`,
            showDenyButton: true,
            showCancelButton: false,
            confirmButtonText: `Sayang`,
            denyButtonText: `Tak Sayang`,
          }).then((result) => {
            ...
            if (result.isConfirmed) {
              ...
              Swal.fire(`Sungguh ni tak suka ${sender}?`, '', 'error').then(function () {
                Swal.fire('Takpa lah awak :((')
              })
            }
          })
